...
static string Login_LogFileName = "LoginRegister.txt";
...
public:
    ...
    struct stLoginRegisterRecord {
        ...
        string Password;
        int Permission;
        stLoginRegisterRecord() :DateTime(""), UserName(""), Password(""), Permission(0) {}
    };
private:
...
private:
    ...
    static stLoginRegisterRecord _convertLoginRegisterLineToRecord(string Line,string Seperator="#//#") {
        ...
        vector<string>LoginRegisterData = ClsString::splitString(Line, Seperator);
        LoginRegisterRecord.DateTime = LoginRegisterData[0];
        LoginRegisterRecord.UserName = LoginRegisterData[1];
        LoginRegisterRecord.Password = LoginRegisterData[2];
        LoginRegisterRecord.Permission = stoi(LoginRegisterData[3]);
