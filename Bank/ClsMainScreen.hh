...
private:
    ...
    enum enMainScreenOptions {
        ...
        eManageUsers = 7, eShowLoginRegister=8, eExit = 9
    };

    static short _readMainMenueOption() {
        cout << setw(37) << left << "" << "Chose what do you want [1 - 9]" << endl;
        short choice = ClsValidate::readIntNumberBetween(1, 9, "Enter Number between 1 to 9?");
        return choice;
    }
